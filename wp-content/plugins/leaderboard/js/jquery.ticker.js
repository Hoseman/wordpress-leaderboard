...
(function(jQuery) {
    ...
    jQuery.fn.ticker = function(options) {
        ...
        return this.each(function () {
            ...
            var tickerContainer = jQuery(this);                     // Outer-most ticker container
            ...
            headlineElements.each(function (index, element) {
                h = stripTags(jQuery(this).html(), allowedTags); // Strip all but the allowed tags
