...
?>	
    ...
    <select name="sales_person" id="name" class="form-control" required >
<?php	
	if($valid) {
...
if($valid) {
		foreach ($wpdb->get_results($SQL) as $key => $row) {
			...
			?>
            <tr>
            	<form action="<?php echo site_url(); ?>/wp-admin/admin.php?page=points_results" method="post">
                    ...
                    <td>
                    	<div class="btn-group" role="group">
							...
							-->
							<a href="<?php echo site_url(); ?>/wp-admin/admin.php?page=points_results&deletescoreid=<?php echo $id; ?>&action=listaction2" onclick="return confirm('Are you sure you want to delete?')"><span class="btn btn-primary glyphicon glyphicon-trash"></span></a>
